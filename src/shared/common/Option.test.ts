...
describe("Option", () => {
  ...
  describe("`unwrapOrElse` method", () => {
    it("should return the value if the option is some", () => {
      ...
      expect(option.unwrapOrElse(() => "default")).toBe("value");
    });

    it("should return the default value if the option is none", () => {
      const option = new None();

      expect(option.unwrapOrElse(() => "default")).toBe("default");
    });
  });
  ...
  describe("`andThen` method", () => {
    it("should return the mapped value if the option is some", () => {
      ...
      expect(option.andThen((value) => Some.of(value + " mapped"))).toStrictEqual(
        new Some("value mapped")
      );
    });
  ...
  describe("`orElse` method", () => {
    it("should return the option if the option is some", () => {
      ...
      expect(option.orElse(() => Some.of("other"))).toStrictEqual(option);
    });
    ...
    it("should return the other option if the option is none", () => {
      ...
      expect(option.orElse(() => other)).toStrictEqual(other);
    });
    ...
    it("should return the other option if the option is some but other is none", () => {
      ...
      expect(option.orElse(() => other)).toStrictEqual(option);
    });
  });
  ...
  describe("`unzipWith` method", () => {
    it("should return a new some option with the unzipped value if the option is some", () => {
      const x: Option<[number, string]> = Some.of([1, "hi"]);
    ...
    it("should return a new none option if the option is none", () => {
      const x: Option<[number, string]> = new None();
      const [y, z] = x.unzipWith(([a, b]) => [a + 1, b + "!"]);
